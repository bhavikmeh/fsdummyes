sap.ui.define([
	...
	return BaseController.extend("bh.fsdummyes.controller.Master", {
		...
		onOpenViewSettings : function (oEvent) {
			...
			if (!this.byId("viewSettingsDialog")) {
				Fragment.load({
					...
					name: "bh.fsdummyes.view.ViewSettingsDialog",
					controller: this
        ...
        {    this.getModel("appView").setProperty("/layout", "TwoColumnsMidExpanded"); 
            ...
            var sIndex = oEvent.getSource().getBindingContextPath().split("'")[1];
